...
import br.edu.ifsc.aquilombar.ui.components.AddressInfo
import br.edu.ifsc.aquilombar.ui.components.BoxInfo
import br.edu.ifsc.aquilombar.ui.components.CardItem
import br.edu.ifsc.aquilombar.ui.components.Carousel
import br.edu.ifsc.aquilombar.ui.components.ExpandableCard
...
fun CampusView(
    ...
    Column(
        ...
        if (campus.value.image.isEmpty()) {
            ...
            val urlList = campus.value.image.map { i ->
                BASE_URL + i.photo
            }
        ...
        /*Row(
            ...
            Box(
                ...
                if (permissionState.hasPermission) {
                    val mapCenter by campusViewModel.loc.collectAsState(
                        initial = LatLng(
                            -26.1833444,
                            -50.3670326
                        )
